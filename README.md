...
The `schema.rs` file is auto-generated by Diesel and should not be edited manually. It defines the Rust representations of our database tables and is used by Diesel to perform type-safe queries.